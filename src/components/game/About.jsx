...
function About({ user }) {
    ...
    return <div className="w-1/2 h-3/5 p-14 py-7 items-start justify-start flex flex-col relative">
        ...
        <img className="absolute bottom-10 right-10" src={map} style={{ width: "120px" }}></img>
    </div>
}
